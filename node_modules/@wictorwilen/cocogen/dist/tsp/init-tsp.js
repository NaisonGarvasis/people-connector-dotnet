...
function defaultModelName(kind) {
    return kind === "people" ? "PersonProfile" : "Item";
}
function defaultIdProperty(kind) {
    return kind === "people" ? "userPrincipalName" : "id";
}
function ensureTspExtension(value) {
    return value.endsWith(".tsp") ? value : `${value}.tsp`;
}
function defaultPackageJsonContents() {
...
export async function initStarterTsp(options) {
...
//# sourceMappingURL=init-tsp.js.map