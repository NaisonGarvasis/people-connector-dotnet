...
export function buildCsPrincipalExpression(fields, fallbackSource) {
    ...
    for (const entry of entries) {
        ...
        if (propertyName) {
            ...
            additionalDataEntries.push(`        [${JSON.stringify(entry.key)}] = ${withDefault},`);
        }
    }
...
export function buildCsPrincipalCollectionExpression(fields, fallbackSource) {
    const entries = buildPrincipalFieldEntries(fields, fallbackSource);
    if (entries.length === 0)
