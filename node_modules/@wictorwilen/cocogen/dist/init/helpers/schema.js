...
export function graphBaseUrlForOperation(ir, operation) {
...
export function schemaPayload(ir) {
    return {
...
export function toGraphPropertyTypeEnumName(type) {
    switch (type) {
        case "string":
            return "String";
        case "boolean":
...
export function toOdataCollectionType(type) {
    switch (type) {
        case "stringCollection":
...
export function toCsParseFunction(type) {
    switch (type) {
        case "stringCollection":
...
export function toCsPropertyValueExpression(type, csPropertyName) {
    switch (type) {
        case "dateTime":
