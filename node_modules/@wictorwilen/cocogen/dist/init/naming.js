...
export function toCsIdentifier(name) {
...
export function toCsPascal(name) {
    if (!name)
        return "Value";
    return name.slice(0, 1).toUpperCase() + name.slice(1);
}
/** Choose a unique C# property name avoiding collisions. */
export function toCsPropertyName(name, itemTypeName, used) {
...
export function toTsIdentifier(name) {
...
export function toSchemaFolderName(connectionName) {
...
export function toTsSchemaFolderName(connectionName) {
    const cleaned = (connectionName ?? "").trim();
    if (!cleaned)
        return "schema";
...
export function toCsNamespace(projectName) {
